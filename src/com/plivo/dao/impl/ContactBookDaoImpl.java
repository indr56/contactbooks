...
public class ContactBookDaoImpl implements ContactBookDao {
    ...
    @Autowired
    public ContactBookDaoImpl(String tableName, int paginationFactor) {
    ...
    public GetResponse get(String email, String name, int pageNumber) throws ContactDaoException {
        ...
        try {
            while (cursor.next() && cursor.getRow() <= paginationFactor) {
            ...
            nextPageToken = cursor.getRow() > paginationFactor;
